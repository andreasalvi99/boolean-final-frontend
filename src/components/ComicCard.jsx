      ...
      <div className="col">
          ...
          >
            ...
            <div className="card-body d-flex flex-column justify-content-around align-items-center bebas-neue-regular p-3">
              ...
              <div>
                <span className={`fs-6 d-inline me-1 ${isDiscount ? "text-decoration-line-through" : ""}`}>
                  {price} &euro;
                </span>
                {isDiscount && (
            ...
            <button type="button" className="btn btn-outline-dark mx-auto mb-2 p-1" style={{ width: "93%" }}
