...
export default function CheckoutForm() {
  ...
  const shippingCost =
    formData.shipping_method === "express" ? expressShippingFee : 0;
  ...
  async function createOrder(e) {
    ...
    const response = await axios.post(
      "https://laravel-final-backend.onrender.com/api/orders",
      {
        ...formData,
        total,
    ...
    <form className="row g-3 mt-3" onSubmit={createOrder}>
      <div className="col-md-3">
        ...
        <input
          name="firstname"
          type="text"
          className={`form-control ${fieldErrors.firstname ? "is-invalid" : ""} ${!fieldErrors.firstname && formData.firstname !== "" ? "is-valid" : ""}`}
          id="firstname"
      ...
      <div className="col-md-3">
        ...
        <input
          name="lastname"
          type="text"
          className={`form-control ${fieldErrors.lastname ? "is-invalid" : ""} ${!fieldErrors.lastname && formData.lastname !== "" ? "is-valid" : ""}`}
          id="lastname"
      ...
      <div className="col-md-6">
        ...
        <input
          name="email"
          type="text"
          className={`form-control ${fieldErrors.email ? "is-invalid" : ""} ${!fieldErrors.email && formData.email !== "" ? "is-valid" : ""}`}
          id="email"
      ...
      <div className="col-md-2">
        ...
        <select
          name="address_type"
          id="address_type"
          className={`form-select ${fieldErrors.address_type ? "is-invalid" : ""} ${!fieldErrors.address_type && formData.address_type !== "" ? "is-valid" : ""}`}
        ...
        {fieldErrors.address_type && (
          <div className="invalid-feedback">{fieldErrors.address_type}</div>
        )}
      </div>
      <div className="col-md-9">
        ...
        <input
          name="address"
          type="text"
          className={`form-control ${fieldErrors.address ? "is-invalid" : ""} ${!fieldErrors.address && formData.address !== "" ? "is-valid" : ""}`}
          id="address"
      ...
      <div className="col-md-1">
        ...
        <input
          name="house_number"
          type="text"
          className={`form-control ${fieldErrors.house_number ? "is-invalid" : ""} ${!fieldErrors.house_number && formData.house_number !== "" ? "is-valid" : ""}`}
          id="house_number"
          value={formData.house_number}
          onChange={handleChanges}
        />
        {fieldErrors.house_number && (
          <div className="invalid-feedback">{fieldErrors.house_number}</div>
        )}
      </div>
      <div className="col-md-3">
        ...
        <input
          name="city"
          type="text"
          className={`form-control ${fieldErrors.city ? "is-invalid" : ""} ${!fieldErrors.city && formData.city !== "" ? "is-valid" : ""}`}
          id="city"
          value={formData.city}
          onChange={handleChanges}
        />
      ...
      <div className="col-md-1">
        ...
        <input
          name="province"
          type="text"
          className={`form-control ${fieldErrors.province ? "is-invalid" : ""} ${!fieldErrors.province && formData.province !== "" ? "is-valid" : ""}`}
          id="province"
          value={formData.province}
          onChange={handleChanges}
        />
        {fieldErrors.province && (
          <div className="invalid-feedback">{fieldErrors.province}</div>
        )}
      </div>
      <div className="col-md-2">
        ...
        <input
          ...
          type="text"
          maxLength={5}
          className={`form-control ${fieldErrors.zipcode ? "is-invalid" : ""} ${!fieldErrors.zipcode && formData.zipcode !== "" ? "is-valid" : ""}`}
          id="zipcode"
      ...
      <button type="submit" className="btn btn-success my-5">
        Vai al pagamento <i className="bi bi-arrow-right"></i>
      </button>
    </form>
  );
}
