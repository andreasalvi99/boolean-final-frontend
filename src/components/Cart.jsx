    ...
    <>
      ...
      >
        <div className="offcanvas-header pb-1">
          <h5
            className="offcanvas-title bangers-regular h3"
                    ...
                    <div className="card mb-3">
                      <div className="row g-0">
                        <div className="col-md-4">
                          <img
                            src={`https://laravel-final-backend.onrender.com/img/${item.comic.cover_img}`}
                          ...
                          <div className="card-body d-flex flex-column justify-content-between h-100 pb-2">
                            <div className="d-flex justify-content-between align-items-center gap-2">
                              <h5 className="card-title m-0">
                                {item.comic.title.length < 18
                                  ? item.comic.title
                                  : `${item.comic.title.substring(0, 19)}...`}
                              </h5>
                              <button
                            ...
                            <div className="d-flex justify-content-between align-items-end">
                              <div className="mb-0 d-flex justify-content-center align-items-center gap-2">
                                <span className="fs-5">Quantità:</span>
                                <div>
                                  <button
                              ...
                              <p className="mb-0">
                                {Math.round(
                                  item.comic.price * item.quantity * 100,
                                ) / 100}
                                &euro;
                              </p>
                            </div>
        ...
        <div className="d-flex justify-content-between bangers-regular align-items-center px-2 border border-dark-subtle border-end-0 border-start-0 border-bottom-0">
          ...
          {cart.length > 0 && (
            <span className="fs-4">
              {cart
                .reduce(
                  (total, item) => total + item.comic.price * item.quantity,
                  0,
                )
                .toFixed(2)}
              &euro;
          ...
          {cart.length === 0 && <span className="fs-4"></span>}
        </div>
        <button
          type="button"
      ...
      <div
        className="modal fade bebas-neue-regular"
        id="staticBackdrop"
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="staticBackdropLabel">
                sicuro di voler eliminare il carrello?
              </h1>
              <button
                type="button"
                className="btn-close"
